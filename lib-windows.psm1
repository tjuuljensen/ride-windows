...
# Install module NuGet module to enable Windows Update over Powershell
...
InstallWinget {
  ...
  if (-not [Environment]::GetEnvironmentVariable("RIDEVAR-Download-Only", "Process")) {
    ...
    # Install 
    try {
      Add-AppxPackage Microsoft.VCLibs.x64.14.00.Desktop.appx -SkipLicense
      Add-AppxPackage Microsoft.UI.Xaml.2.7.x64.appx -SkipLicense
      Add-AppxPackage Microsoft.DesktopAppInstaller_8wekyb3d8bbwe.msixbundle -SkipLicense
      Write-Output "Installation done for $SoftwareName"
    }
    catch {
      Write-Output "Installation failed for $SoftwareName"
    } 
  }
}
...
function InstallADReplStatus{

  Write-Output "###"
  $SoftwareName = "ADReplStatus"
  Write-Output "Installing $SoftwareName..."
...
function InstallFirewallNotifier{
  # https://github.com/wokhan/WFN
  
  Write-Output "###"
  $SoftwareName = "FirewallNotifier"
  Write-Output "Installing $SoftwareName..."
  ...
  $FullDownloadURL = ($ReleasePageLinks | Where-Object { $_ -Like "*zip*" -and $_ -Like "*x64*" -and $_ -NotLike "*nightlies*"} | Select-Object -First 1 )
  if (-not $FullDownloadURL) {
	Write-Output "Error: $SoftwareName not found"
	return
  }
...
function RemoveFirewallNotifier {
  Write-Output "###"
  $SoftwareName = "FirewallNotifier"
  Write-Output "Removing $SoftwareName..."
...
function AudioMute{
  ...
  Write-Output "###"
  Write-Output "Muting audio..."

  # Code block connecting to Core Audio API
  $code = @'
// Originates from https://stackoverflow.com/questions/255419/how-can-i-mute-unmute-my-sound-from-powershell
